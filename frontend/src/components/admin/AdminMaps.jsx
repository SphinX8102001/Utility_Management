...
const HATCH_PATTERN_ID = 'bd-hatch-admin';
...
// Preview Dashboard Map Component
...
// Full Fullscreen Map Layer
export function AdminFullMap({ outages, selectedIncident, setSelectedIncident }) {
  React.useEffect(() => {
    injectHatchPattern();
  }, []);
  ...
  return (
    <MapContainer center={DHAKA_CENTER} zoom={FULL_MAP_ZOOM} style={{ height: '100%', width: '100%' }} className="rounded-2xl">
      <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" attribution="&copy; OpenStreetMap contributors" />
